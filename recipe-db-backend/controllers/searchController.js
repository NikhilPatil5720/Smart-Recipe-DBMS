...
//new version with dietary_type filter
exports.searchRecipes = (req, res) => {
    const { keyword, dietary_type } = req.query;
    ...
    if (keyword) {
        // Match keyword against title, cuisine name, or ingredient name
        conditions.push('(r.title LIKE ? OR c.name LIKE ? OR i.name LIKE ?)');
